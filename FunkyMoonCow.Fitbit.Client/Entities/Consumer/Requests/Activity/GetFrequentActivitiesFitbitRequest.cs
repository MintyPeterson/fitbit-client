...
{
  /// <summary>
  /// Provides a <see cref="FitbitRequest"/> for retrieving a list of a user's frequent activities.
  /// </summary>
  public class GetFrequentActivitiesFitbitRequest : FitbitRequest
  {
    /// <summary>
    ...
    /// <summary>
    /// Intialises a new instance of the <see cref="GetFrequentActivitiesFitbitRequest"/>
    /// class.
    /// </summary>
    public GetFrequentActivitiesFitbitRequest()
    {
    ...
    {
      return string.Format("/1/user/{0}/activities/frequent.json", this.UserId);
    }
